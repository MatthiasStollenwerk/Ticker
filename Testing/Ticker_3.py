...
def main():
    ...
    try:
        ...
        # Set the rotation and brightness of the unicorn hat
       ...
       # Load the images for the mushroom and shell
        try:
            ...
            mushroom = load_image("/home/mstoll/Learning/StockTicker/mushroom.png")
            shell = load_image("/home/mstoll/Learning/StockTicker/shell.png")
